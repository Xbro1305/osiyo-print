...
export const Finish = () => {
  ...
  const groupData = () => {
    ...
    axios(`${baseUrl}/printing/finish/group`, {
      method: "GET",
  ...
  const handleEdit = (e: React.FormEvent) => {
    ...
    axios(`${baseUrl}/printing/finish/${editing?._id}`, {
      method: "PATCH",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
  ...
  const exportExcel = async () => {
    try {
      const response = await axios.post(
        `${baseUrl}/printing/finish/export`,
        { ids: selectedIds },
        {
          responseType: "blob",
          headers: {
      ...
      link.href = url;
      link.setAttribute("download", "finish.xlsx");
            ...
            <div className="flex items-center gap-lg justify-end">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  axios(`${baseUrl}/printing/finish/${deleting._id}`, {
                    method: "DELETE",
                    headers: {
                      Authorization: `Bearer ${localStorage.getItem("token")}`,
                    },
